...
const Library = createLucideIcon("library", __iconNode$4);
const __iconNode$3 = [
  ["circle", { cx: "8", cy: "18", r: "4", key: "1fc0mg" }],
  ["path", { d: "M12 18V2l7 4", key: "g04rme" }]
];
const Music2 = createLucideIcon("music-2", __iconNode$3);
const __iconNode$2 = [
...
function EkhoLayout() {
  ...
  const iconBtn = (active) => `w-10 h-10 rounded-lg grid place-items-center transition ${active ? "bg-primary/20 text-primary glow-violet" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-30 glass border-b", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 mr-2 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary/20 border border-primary/40 grid place-items-center glow-violet", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Music2, { className: "w-5 h-5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xl font-bold text-primary text-glow-violet hidden sm:inline", children: "EKHO" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: iconBtn(loc.pathname === "/"), "aria-label": "Inicio", children: /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "w-5 h-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/library", className: iconBtn(isActive("/library")), "aria-label": "Biblioteca", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Library, { className: "w-5 h-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/status", className: iconBtn(isActive("/status")), "aria-label": "Sistema", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-5 h-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/convert", className: iconBtn(isActive("/convert")), "aria-label": "Conversor", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "w-5 h-5" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-xl mx-auto relative hidden md:block", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/settings", className: iconBtn(isActive("/settings")), "aria-label": "Configuración", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-5 h-5" }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "hidden md:block py-6 text-center text-xs text-muted-foreground font-mono", children: "EKHO v0.1.0 — built with ♪ for music lovers" })
  ] });
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center glass rounded-2xl p-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-mono font-bold text-primary text-glow-violet", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "Esta pista no existe en la biblioteca." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "mt-6 inline-flex rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90", children: "Volver al inicio" })
  ] }) });
}
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(EkhoLayout, {}) });
}
const $$splitComponentImporter$6 = () => import("./status-Zxjz_uly.js");
const Route$6 = createFileRoute("/status")({
  head: () => ({
    meta: [{
      title: "Estado del Sistema — EKHO"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./settings-BByMk4f-.js");
const Route$5 = createFileRoute("/settings")({
  head: () => ({
    meta: [{
      title: "Configuracion — EKHO"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./library-CDNgOB4L.js");
const Route$4 = createFileRoute("/library")({
  head: () => ({
    meta: [{
      title: "Biblioteca — EKHO"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./convert-CdcIDBrD.js");
const Route$3 = createFileRoute("/convert")({
  head: () => ({
    meta: [{
      title: "Conversor — EKHO"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-CxNM-d1F.js");
...
const $$splitComponentImporter$1 = () => import("./library.index-mQmUoZSO.js");
const Route$1 = createFileRoute("/library/")({
  head: () => ({
    meta: [{
      title: "Biblioteca — EKHO"
    }]
...
const api = isBrowser ? window.pywebview?.api : null;
const bridge = {
  async getPlaylists() {
    if (!api) return [];
    return await api.get_playlists();
  },
  async getPlaylistSongs(playlistId) {
    if (!api) return [];
    return await api.get_playlist_songs(playlistId);
  },
  async getSongs() {
    return bridge.getPlaylistSongs("all");
  },
  async convertYoutube(url) {
    try {
...
const $$splitComponentImporter = () => import("./library._playlistId-CPHnkeW_.js");
const $$splitErrorComponentImporter = () => import("./library._playlistId-gDwHfJQG.js");
const $$splitNotFoundComponentImporter = () => import("./library._playlistId-CKrRXqti.js");
const Route2 = createFileRoute("/library/$playlistId")({
  head: ({
    params
  }) => {
    return {
...
const StatusRoute = Route$6.update({
  id: "/status",
  path: "/status",
...
const ConvertRoute = Route$3.update({
  id: "/convert",
  path: "/convert",
  getParentRoute: () => Route$7
});
...
const LibraryIndexRoute = Route$1.update({
  id: "/",
  path: "/",
  getParentRoute: () => LibraryRoute
});
const LibraryPlaylistIdRoute = Route2.update({
  id: "/$playlistId",
  path: "/$playlistId",
  getParentRoute: () => LibraryRoute
});
const LibraryRouteChildren = {
  LibraryPlaylistIdRoute,
  LibraryIndexRoute
};
